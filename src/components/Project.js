...
const Project = () => {
  ...
  const projectScreenshots = [userImage, scheduleImage, mapImage];
  ...
  return (
    <div className="project-container" ref={ref}>
      ...
      <div className="project-description">
        <h2>Presensi</h2>
        <p>
          Ini adalah Project pribadi yang yaitu presensi. Project ini adalah
          aplikasi mobile presensi (absensi) yang dibangun menggunakan Flutter
          untuk tampilan antarmuka (frontend) dan Laravel Filament sebagai
          backend (administrasi) yang terhubung melalui API. Fitur Utama:
          Login/Registrasi, Clock-in/Clock-out, Riwayat Presensi, Dashboard
          Admin.
        </p>
      </div>
    </div>
